...
map wu :set nosplitbelow<CR>:split<CR>:set splitbelow<CR>
map wd :set splitbelow<CR>:split<CR>
map wl :set nosplitright<CR>:vsplit<CR>:set splitright<CR>
map wr :set splitright<CR>:vsplit<CR>
...
noremap wh <C-w>t<C-w>K
" Place the two screens side by side
noremap wv <C-w>t<C-w>H

" Rotate screens
noremap wrh <C-w>b<C-w>K
noremap wrv <C-w>b<C-w>H
...
" ===
"nnoremap <S-S> :ls<CR>
nnoremap <S-b> :enew<CR>
nnoremap <S-l> :bnext<CR>
nnoremap <S-h> :bprevious<CR>
nnoremap <S-d> :bdelet<CR>
...
let s:vim_tags=expand('~/.cach/tags')
let g:gutentags_cache_dir=s:vim_tags
if !isdirectory(s:vim_tags)
  silent! call mkdir(s:vim_tags,'p')
endif
"let g:gutentags_ctag_extra_args=['--fields=+niazS','--extra=+q']
"let g:gutentags_ctag_extra_args+=['--c++-kinds=+pxl']
"let g:gutentags_ctag_extra_args+=['--c-kinds=+pxl']
"let g:gutentags_ctag_extra_args
...
"`autocmd WinEnter * silent! iunmap <C-e>
"`autocmd WinEnter * silent! unmap <C-e>
"`autocmd WinEnter * silent! vunmap <C-e>
